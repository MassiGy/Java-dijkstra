...
1. Description du générateur utilisé et ses paramètres
...
2. Description de l'algorithme de Dijkstra implémenté
...
3. Description de l'algorithme de Dijkstra de GraphStream
...
4. Description des tests effectués et justification des choix
